...
import { PmeComponent } from 'app/entities/pme/pme.component';
import { PmeService } from 'app/entities/pme/pme.service';
import { Pme } from 'app/shared/model/pme.model';

describe('Component Tests', () => {
    describe('Pme Management Component', () => {
        let comp: PmeComponent;
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.pmes[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
