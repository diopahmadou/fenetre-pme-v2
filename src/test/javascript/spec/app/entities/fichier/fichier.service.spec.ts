...
describe('Service Tests', () => {
    describe('Fichier Service', () => {
        ...
        beforeEach(() => {
            ...
            elemDefault = new Fichier(0, 'AAAAAAA', 'AAAAAAA', 'image/png', 'AAAAAAA');
        });
        ...
        describe('Service methods', async () => {
            ...
            it('should create a Fichier', async () => {
            ...
            it('should update a Fichier', async () => {
                const returnedFromService = Object.assign(
                    {
                        fileName: 'BBBBBB',
                        fileType: 'BBBBBB',
            ...
            it('should return a list of Fichier', async () => {
                const returnedFromService = Object.assign(
                    {
                        fileName: 'BBBBBB',
                        fileType: 'BBBBBB',
            ...
            it('should delete a Fichier', async () => {
